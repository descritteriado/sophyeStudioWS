...
/**
 * The persistent class for the tempemployment database table.
 * 
 */
@Entity
@NamedQuery(name="Tempemployment.findAll", query="SELECT t FROM Tempemployment t")
public class Tempemployment implements Serializable {
	...
	private Tsegcataloguedetail jobPosition;
	...
	public Tsegcataloguedetail getJobPosition() {
		return this.jobPosition;
	}

	public void setJobPosition(Tsegcataloguedetail jobPosition) {
